...
export class FirebaseService {
  ...
  // No me convence este método. Es muy poco directo. Puede fallar si hay una persona cualquiera que no tenga lenguajes asignados
    ...
    setTimeout(
      () => {
        if(currentUser){
          ...
          console.log("no user");
          alert("Languages weren't defined!")
        }
      },1000
    )
    setTimeout(
